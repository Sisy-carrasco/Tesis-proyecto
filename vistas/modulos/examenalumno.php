  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      ...
      <div class="box-header with-border">
        ...
        $examen = ControladorExamen::ctrMostrarExamenAlumno($_SESSION["id"]);
        $c=0;
        foreach ($examen as $key => $value){$c=$c+1;
          $tiempo='';
          ...
          echo ' <tr>
                  ...
                  if(strtotime('now')>=strtotime($value["fecha_inicio"]) && strtotime('now')<=strtotime($value["fecha_fin"])){ 
                    if($value["literales"]=="0"){
                      echo '<td>  
                        <div class="btn-group">
                          <button class="btn btn-info btnExamenLiteral" idExamen="'.$value["id_examen"].'" data-toggle="modal" data-target="#modalExamen"><i class="fa fa-check"></i>Literal</button>
                        </div>  
                      </td>';
                    }else{
                    ...
                    if($value["literales"]>0 && $value["inferenciales"]=="0" && ($value["puntajeliteral"]/$value["totalliteral"])*100>60){
                      echo '<td>
                        <div class="btn-group">
                          <button class="btn btn-info btnExamenInferencial" idExamen="'.$value["id_examen"].'" data-toggle="modal" data-target="#modalExamen"><i class="fa fa-check"></i>Inferencial</button>
                        </div>
                        </td>';
                    ...
                    if($value["inferenciales"]>0 && $value["criticas"]=="0" && ($value["puntajeinferencial"]/$value["totalinferencial"])*100>60){
                      echo '<td>
                        <div class="btn-group">
                          <button class="btn btn-info btnExamenCritico" idExamen="'.$value["id_examen"].'" data-toggle="modal" data-target="#modalExamen"><i class="fa fa-check"></i>Critico</button>
                        </div>
                        </td>';
                    ...
                    echo "<td colspan='3'><button class='btn btn-danger' type='button'>No Disponible</button></td>";
                  }
  ...
  <div class="modal-dialog" style="width:80%;">
    ...
    <div class="modal-content">
      ...
      <form role="form" method="post" enctype="multipart/form-data">
        ...
        <input type="hidden" id="accion" name="accion" value="NuevoExamenAlumno" />
        <input type="hidden" id="idExamen" name="idExamen" value="0" />
        <input type="hidden" id="tabla" name="tabla" value="0" />
        <input type="hidden" id="modo" name="modo" value="Alumno" />
            ...
            <div class="row">
              ...
              <div class="col-md-5"> 
                ...
                <div class="form-group">
                  ...
                  <label for="lectura">Sesion:</label>  
                  
                  <div class="input-group">
                  
                    <span class="input-group-addon"><i class="fa fa-users"></i></span> 

                    <input type="text" class="form-control input-lg" name="sesion" id="sesion" value="" readonly="">
        ...
        <div class="modal-footer">
          ...
          <button type="submit" class="btn btn-primary" id="btnResponderExamen">Responder Examen</button>
        ...
        <?php
          ...
          $contExamen -> ctrResolverExamenCritico();
          $contExamen -> ctrResolverExamenInferencial();
          $contExamen -> ctrResolverExamenLiteral();
